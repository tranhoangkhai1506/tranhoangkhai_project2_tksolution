...
{
	public class CSys_API_Source_Chu_Hang_Function
	{
		private long m_lngAuto_ID;
		private long m_lngAPI_Source_Chu_Hang_ID;
		private long m_lngAPI_Source_Function_ID;
		...
		public CSys_API_Source_Chu_Hang_Function()
		{
			ResetData();
		}
		...
		public void ResetData()
		{
			...
			m_lngAPI_Source_Chu_Hang_ID = CConst.INT_VALUE_NULL;
			m_lngAPI_Source_Function_ID = CConst.INT_VALUE_NULL;
		...
		public long API_Source_Chu_Hang_ID
		{
			get
			{
				return m_lngAPI_Source_Chu_Hang_ID;
			}
			set
			{
				m_lngAPI_Source_Chu_Hang_ID = value;
			}
		}

		public long API_Source_Function_ID
		{
			get
			{
				return m_lngAPI_Source_Function_ID;
			}
			set
			{
				m_lngAPI_Source_Function_ID = value;
			}
		}
