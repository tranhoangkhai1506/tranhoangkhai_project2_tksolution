	...
	public class CDM_Don_Vi_Tinh_Controller
	{
		public List<CDM_Don_Vi_Tinh> FQ_110_DVT_sp_sel_List_By_Created(DateTime? p_dtmFrom, DateTime? p_dtmTo)
		{
			...
			try
			{
				...
				CSqlHelper.FillDataTable(CConfig.TKS_Thuc_Tap_V11_Conn_String, v_dt, "FQ_110_DVT_sp_sel_List_By_Created", p_dtmFrom, p_dtmTo);
		...
		public List<CDM_Don_Vi_Tinh> FQ_110_DVT_sp_sel_List_For_Cache()
		{
			...
			try
			{
				CSqlHelper.FillDataTable(CConfig.TKS_Thuc_Tap_V11_Conn_String, v_dt, "FQ_110_DVT_sp_sel_List_For_Cache");
		...
		public CDM_Don_Vi_Tinh FQ_110_DVT_sp_sel_Get_By_ID(long p_iID)
		{
			...
			try
			{
				CSqlHelper.FillDataTable(CConfig.TKS_Thuc_Tap_V11_Conn_String, v_dt, "FQ_110_DVT_sp_sel_Get_By_ID", p_iID);
		...
		public long FQ_110_DVT_sp_ins_Insert(CDM_Don_Vi_Tinh p_objData)
		{
			...
			try
			{
				v_iRes = Convert.ToInt64(CSqlHelper.ExecuteScalar(CConfig.TKS_Thuc_Tap_V11_Conn_String, "FQ_110_DVT_sp_ins_Insert",
		...
		public long FQ_110_DVT_sp_ins_Insert(SqlConnection p_conn, SqlTransaction p_trans, CDM_Don_Vi_Tinh p_objData)
		{
			...
			try
			{
				v_iRes = Convert.ToInt64(CSqlHelper.ExecuteScalar(p_conn, p_trans, CConfig.TKS_Thuc_Tap_V11_Conn_String, "FQ_110_DVT_sp_ins_Insert",
					p_objData.Ten_Don_Vi_Tinh, p_objData.Ghi_Chu, p_objData.Last_Updated_By, p_objData.Last_Updated_By_Function));
			}
		...
		public void FQ_110_DVT_sp_upd_Update(CDM_Don_Vi_Tinh p_objData)
		{
			try
			{
				CSqlHelper.ExecuteNonquery(CConfig.TKS_Thuc_Tap_V11_Conn_String, "FQ_110_DVT_sp_upd_Update", p_objData.Auto_ID,
					p_objData.Ten_Don_Vi_Tinh, p_objData.Ghi_Chu, p_objData.Last_Updated_By, p_objData.Last_Updated_By_Function);
			}
		...
		public void FQ_110_DVT_sp_upd_Update(SqlConnection p_conn, SqlTransaction p_trans, CDM_Don_Vi_Tinh p_objData)
		{
			try
			{
				CSqlHelper.ExecuteNonquery(p_conn, p_trans, CConfig.TKS_Thuc_Tap_V11_Conn_String, "FQ_110_DVT_sp_upd_Update", p_objData.Auto_ID,
					p_objData.Ten_Don_Vi_Tinh, p_objData.Ghi_Chu, p_objData.Last_Updated_By, p_objData.Last_Updated_By_Function);
			}
		...
		public void FQ_110_DVT_sp_del_Delete_By_ID(long p_iAuto_ID, string p_strLast_Updated_By, string p_strLast_Updated_By_Function)
		{
			try
			{
				CSqlHelper.ExecuteNonquery(CConfig.TKS_Thuc_Tap_V11_Conn_String, "FQ_110_DVT_sp_del_Delete_By_ID", p_iAuto_ID, p_strLast_Updated_By, p_strLast_Updated_By_Function);
			}
