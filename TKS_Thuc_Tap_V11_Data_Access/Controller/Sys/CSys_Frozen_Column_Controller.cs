	...
	public class CSys_Frozen_Column_Controller
	{
        public List<CSys_Frozen_Column> FQ_513_FC_sp_sel_List_By_Created(DateTime? p_dtmFrom, DateTime? p_dtmTo)
        {
            ...
            try
            {
                ...
                CSqlHelper.FillDataTable(CConfig.TKS_Thuc_Tap_V11_Conn_String, v_dt, "FQ_513_FC_sp_sel_List_By_Created", p_dtmFrom, p_dtmTo);
        ...
        public List<CSys_Frozen_Column> FQ_513_FC_sp_sel_List_For_Cache()
        {
            ...
            try
            {
                CSqlHelper.FillDataTable(CConfig.TKS_Thuc_Tap_V11_Conn_String, v_dt, "FQ_513_FC_sp_sel_List_For_Cache");
        ...
        public CSys_Frozen_Column FQ_513_FC_sp_sel_Get_By_ID(long p_iID)
        {
            ...
            try
            {
                CSqlHelper.FillDataTable(CConfig.TKS_Thuc_Tap_V11_Conn_String, v_dt, "FQ_513_FC_sp_sel_Get_By_ID", p_iID);
        ...
        public long FQ_513_FC_sp_ins_Insert(CSys_Frozen_Column p_objData)
        {
            ...
            try
            {
                v_iRes = Convert.ToInt64(CSqlHelper.ExecuteScalar(CConfig.TKS_Thuc_Tap_V11_Conn_String, "FQ_513_FC_sp_ins_Insert",
                    p_objData.Ma_Chuc_Nang, p_objData.SL_Cot_Frozen, p_objData.Last_Updated_By, p_objData.Last_Updated_By_Function));
            }
        ...
        public long FQ_513_FC_sp_ins_Insert(SqlConnection p_conn, SqlTransaction p_trans, CSys_Frozen_Column p_objData)
        {
            ...
            try
            {
                v_iRes = Convert.ToInt64(CSqlHelper.ExecuteScalar(p_conn, p_trans, CConfig.TKS_Thuc_Tap_V11_Conn_String, "FQ_513_FC_sp_ins_Insert",
                    p_objData.Ma_Chuc_Nang, p_objData.SL_Cot_Frozen, p_objData.Last_Updated_By, p_objData.Last_Updated_By_Function));
            }
        ...
        public void FQ_513_FC_sp_upd_Update(CSys_Frozen_Column p_objData)
        {
            try
            {
                CSqlHelper.ExecuteNonquery(CConfig.TKS_Thuc_Tap_V11_Conn_String, "FQ_513_FC_sp_upd_Update", p_objData.Auto_ID,
                    p_objData.Ma_Chuc_Nang, p_objData.SL_Cot_Frozen, p_objData.Last_Updated_By, p_objData.Last_Updated_By_Function);
            }
        ...
        public void FQ_513_FC_sp_upd_Update(SqlConnection p_conn, SqlTransaction p_trans, CSys_Frozen_Column p_objData)
        {
            try
            {
                CSqlHelper.ExecuteNonquery(p_conn, p_trans, CConfig.TKS_Thuc_Tap_V11_Conn_String, "FQ_513_FC_sp_upd_Update", p_objData.Auto_ID,
                    p_objData.Ma_Chuc_Nang, p_objData.SL_Cot_Frozen, p_objData.Last_Updated_By, p_objData.Last_Updated_By_Function);
            }
        ...
        public void FQ_513_FC_sp_del_Delete_By_ID(long p_iAuto_ID, string p_strLast_Updated_By, string p_strLast_Updated_By_Function)
        {
            try
            {
                CSqlHelper.ExecuteNonquery(CConfig.TKS_Thuc_Tap_V11_Conn_String, "FQ_513_FC_sp_del_Delete_By_ID", p_iAuto_ID, p_strLast_Updated_By, p_strLast_Updated_By_Function);
            }
