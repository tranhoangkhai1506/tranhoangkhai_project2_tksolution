...
namespace TKS_Thuc_Tap_V11_Data_Access.Controller.Cache
{
	...
	{
		private static List<CSys_Import_Excel_Template_Config> Arr_Data = new();
		private static Dictionary<long, CSys_Import_Excel_Template_Config> Dic_Data_ID = new();
		private static Dictionary<long, CSys_Import_Excel_Template_Config> Dic_Data_Chu_Hang = new();
		...
		public static void Delete_Data(long p_iAuto_ID)
		{
			...
			CSys_Import_Excel_Template_Config v_objData = Dic_Data_ID[p_iAuto_ID];
