...
namespace TKS_Thuc_Tap_V11_Data_Access.Controller.Cache
{
    public class CCache_Column_Width
    {
        ...
        private static Dictionary<string, CSys_Column_Width> Dic_Data_Code = new Dictionary<string, CSys_Column_Width>();
        private static Dictionary<long, CSys_Column_Width> Dic_Data_ID = new Dictionary<long, CSys_Column_Width>();
        ...
        public static void Delete_Data(long p_iAuto_ID)
        {
            ...
            CSys_Column_Width v_objData = Dic_Data_ID[p_iAuto_ID];
